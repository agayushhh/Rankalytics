...
data.loc[data['Year'] == 2016, 'Gender'] = 'Neutral'
data.loc[data['Year'] != 2016, 'Gender'] = data['Gender'].apply(lambda x: 'Neutral' if pd.notnull(x) and 'Gender-Neutral' in x else 'Female')
